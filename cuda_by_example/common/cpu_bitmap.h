...
struct CPUBitmap {
    ...
    [[nodiscard]] CPUBitmap( int width, int height, void *d = nullptr ) {
    ...
    [[nodiscard]] unsigned char* get_ptr() const   { return pixels; }
    [[nodiscard]] long image_size() const { return x * y * 4; }
